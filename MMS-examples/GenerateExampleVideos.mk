...
%.mp4: %.mms.csv
	$(BLENDER_EXE) --background --python-exit-code 1 --python main.py -- --dictionary-dir "$(DICTIONARY_DIR)" --source-mms-file "$<" --use-relative-time --export-mp4 "$@" --render-size-pct 50 --log-to-console --gloss-panel
